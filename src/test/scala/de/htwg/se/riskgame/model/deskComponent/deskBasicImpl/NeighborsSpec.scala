  ...
  "A Neighbors" when {
    "created" should {
      ...
      "mark neighbors out of the bounds as None" in {
        val edgeNeighbors = deskBasicImpl.Neighbors(0, 0, fields)
        ...
        val otherEdgeNeighbors = deskBasicImpl.Neighbors(2, 2, fields)
      ...
      "give the (x, y)-coordinates of the neighbors inside a map" in {
        val neighbors = deskBasicImpl.Neighbors(1, 1, fields)
      ...
      "return its center position and the field all neighbors are depending on" in {
        ...
        val neighbors = deskBasicImpl.Neighbors(1, 1, changedMatrix)
